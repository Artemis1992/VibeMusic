...
from .views import PostListView, ArtistDetailView, GenreDetailView, add_comment, PostCreateView, about, contact, profile, PostDetailView, RegisterView, logout_user

app_name = 'vibemusic'

urlpatterns = [
    path('', PostListView.as_view(), name='home'),
    path('artist/<slug:artist_slug>/', ArtistDetailView.as_view(), name='artist_detail'),
